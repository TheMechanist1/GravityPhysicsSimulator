...
import com.mechanist.gravityphysicssimulator.utils.FileUtils;
...
public class Shader {
    ...
    public void create() {
        ...
        if (GL20.glGetShaderi(fragmentID, GL20.GL_COMPILE_STATUS) == GL11.GL_FALSE) {
            System.err.println("Fragment Shader Ran into a problem: " + GL20.glGetShaderInfoLog(fragmentID));
            return;
        }
        ...
        if (GL20.glGetProgrami(programID, GL20.GL_LINK_STATUS) == GL11.GL_FALSE) {
            System.err.println("Program Linking Had A Problem: " + GL20.glGetProgramInfoLog(programID));
            return;
        }

        GL20.glValidateProgram(programID);
        if (GL20.glGetProgrami(programID, GL20.GL_VALIDATE_STATUS) == GL11.GL_FALSE) {
            System.err.println("Program Validation Had A Problem: " + GL20.glGetProgramInfoLog(programID));
            return;
        }
